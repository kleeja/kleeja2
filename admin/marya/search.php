...
<li class="list-group-item form-group">
	...
	<p class="list-group-item-text">
		<input type="text" name="filename" id="filename" value=""  class="form-control f_search" placeholder="<?=$lang['FILENAME']?>">
	</p>
</li>
<li class="list-group-item form-group">
...
<li class="list-group-item form-group">
	...
	<p class="list-group-item-text">
		<input type="text" name="ext" id="ext" value="" class="form-control f_search" placeholder="<?=$lang['FILETYPE']?>">
	</p>
</li>
...
<li class="list-group-item form-group">
	...
	<p class="list-group-item-text input-group">
		...
		<input type="text" id="size" name="size"  class="form-control f_search" placeholder="<?=$lang['FILESIZE']?>">
...
<li class="list-group-item form-group">
	...
	<p class="list-group-item-text input-group">
		...
		<input type="text" id="rep" name="rep"  class="form-control f_search" placeholder="<?=$lang['REPORT']?>"/>
	</p>
</li>
...
<li class="list-group-item form-group">
	...
	<input type="text" name="lastdown" id="lastdown" value="" class="form-control f_search" placeholder="<?=$lang['LAST_DOWN']?>">
...
<li class="list-group-item form-group">
	...
	<p class="list-group-item-text">
		<input type="text" name="user_ip" id="user_ip" value="<?=$filled_ip?>" size="20" class="form-control f_search" placeholder="<?=$lang['IP']?>">
	</p>
</li>
...
<p class="submit <?php if($lang['DIR'] == 'rtl'):?> pull-left<?php endif;?>">
	...
	<button type="submit" id="submit" name="search_file" class="btn btn-primary"><?=$lang['SEARCH_SUBMIT']?></button>
</p>
...
<li class="list-group-item form-group">
	<h4 class="list-group-item-heading"><label for="username"><?=$lang['USERNAME']?></label></h4>
	<p class="list-group-item-text">
		<input type="text" name="username" id="username" value="" placeholder="<?=$lang['USERNAME']?>" class="form-control f_search">
	</p>
</li>
...
<li class="list-group-item form-group">
	...
	<p class="list-group-item-text input-group">
		<input type="text" name="usermail" id="usermail" value="" placeholder="<?=$lang['EMAIL']?>" class="form-control f_search">
	</p>
</li>
