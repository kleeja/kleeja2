...
$lang = array_merge($lang, array(
	...
	'IDF' 					=> 'الاساسي (http://example.com/do.php?id=123)',
	'IDFF' 					=> 'إسم الملف (http://example.com/do.php?file=filename.pdf)',
	...
	'SELECT_GRP_CHNG_EXTS'	=> 'حدد مجموعة ليتم تعديل اعدادات الامتدادات لها، واضافة امتدادات ملفات مسموحة جديدة',
	...
	'TAKE_BK' 				=> 'أخذ نسخة',
	'REPAIRED_TABLE' 		=> '[جداول] تم إصلاح ',
	'REPAIRED_CACHE' 		=> 'تم حذف/تجديد الكاش (الملفات المؤقته) ...',
	...
	'R_EXTENSIONS' 			=> 'إعدادات الإمتدادات',
	'R_FILES' 				=> 'إدارة الملفات',
	'R_REPORTS' 			=> 'التحكم بالتبليغات',
	'R_MESSAGES' 			=> 'التحكم بالمراسلات',
	...
	'SHOWFILESBYIP'				=> 'ملفات الـ IP',
	'IP_INFO'					=> 'معلومات الـIP',
	...
	'DIRECT_FILE_NOTE'			=> 'لا احصائيات للملفات المباشرة.',
	...
	'SUPPORT_TXT_FILE'			=> 'ملف يحتوي على معلومات عن مركزك لتعطيها للدعم الفني عند السؤال',
